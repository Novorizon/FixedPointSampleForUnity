...
//            AABB aabb = new AABB(math.fix3(go.transform.position - go.transform.localScale / 2), math.fix3(go.transform.position + go.transform.localScale / 2));
//            go.name = "AABB" + i;
//            AABBs.Add(go, aabb);
//        }
//        for (int i = 0; i < length; i++)
...
//            float z = Mathf.Abs(UnityEngine.Random.insideUnitSphere.z);
//            go.transform.localScale = go.transform.localScale + new Vector3(x, y, z) * 2;
//            OBB obb = new OBB(math.fix3(go.transform.position - go.transform.localScale / 2), math.fix3(go.transform.position + go.transform.localScale / 2), quaternion.identity);
...
//            Sphere sphere = new Sphere(math.fix3(go.GetComponent<SphereCollider>().center), new fix(go.transform.localScale.x / 2));
//            go.AddComponent<Speed>().speed = UnityEngine.Random.Range(1, 3);
//            go.AddComponent<Center>().value = UnityEngine.Random.insideUnitSphere * 5;
...
//            aabb.Update(math.fix3(item.transform.position));
//            AABBs[item] = aabb;
...
//            OBB obb = OBBs[item];
//            obb.Update(math.fix3(item.transform.position), math.fix3(item.transform.forward));
//            OBBs[item] = obb;
...
//            sphere.Update(math.fix3(item.transform.position));
//            Spheres[item] = sphere;
...
//                    continue;
//                if (Geometry.IsOverlapY(item.Value, item1.Value))
//                {
...
//                //for (int i = 0; i < 100; i++)
//                //{
//                //    Geometry.IsOverlapY(item.Value, item1.Value);
//                //}
//                //Profiler.EndSample();
//                //Profiler.BeginSample("bbb");
//                //for (int i = 0; i < 100; i++)
//                //{
//                //    Geometry.IsOverlap(item.Value, item1.Value);
//                //}
//                //Profiler.EndSample();
//                if (Geometry.IsOverlapY(item.Value, item1.Value))
//                {
